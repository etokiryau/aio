...
const SlideCarousel = ({slides, options: { preview = false, arrows, dots, appearence = 'single', objectFit = 'cover', zooming = true, arrowColor = true}, setIsZoomedSlide, isZoomedSetup}) => {
